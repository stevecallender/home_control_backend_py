...
PythonShell.defaultOptions = { scriptPath: '/home/pi/HAP-NodeJS/python/' };
...
var outlet = exports.accessory = new Accessory('Beats', outletUUID);
...
outlet
  ...
  .on('set', function(value, callback) {
    ...
    if (value) {
                         PythonShell.run('tunesOn.py', function (err) {
                                if (err){console.log(err);}
                                console.log('On Success');
                        });
    } 
    else{
                        PythonShell.run('tunesOff.py', function (err) {
                                if (err){console.log(err);}
